...
class ResumeControllerTest {
  ...
  void addVacancy() throws Exception {
    ...
    mockMvc.perform(post("/api/resumes/", mockResume)
        ...
        .content(
            "{\"id\":1,\"resumeName\":\"Ivan CV\",\"status\":\"ACTIVE\",\"experiences\":[{\"id\":1,\"description\":\"Java developing\",\"endDate\":\"2022-06-02T15:40:32.0247436\",\"startDate\":\"2020-06-02T15:40:32.0247436\"}]}"))
        .andDo(print())
        .andExpect(status().isOk());
  }
  ...
  void updateVacancy() throws Exception {
    ...
    mockMvc.perform(put("/api/resumes/" + mockResume.getId(), mockResume)
        .contentType(MediaType.APPLICATION_JSON)
        .content(
            "{\"id\":1,\"resumeName\":\"Ivan CV\",\"status\":\"ACTIVE\",\"experiences\":[{\"id\":1,\"description\":\"Java developing\",\"startDate\":\"2020-06-02T14:29:10.3825003\",\"endDate\":\"2022-06-02T14:29:10.3825003\"}],\"skills\":[],\"user\":{\"id\":1,\"firstname\":\"Ivan\",\"lastname\":\"Petrov\",\"email\":\"Ivan@gmail.com\",\"birthday\":\"1992-06-02T14:29:10.3814968\"}}"))
        .andDo(print())
        .andExpect(status().isOk());
  }
