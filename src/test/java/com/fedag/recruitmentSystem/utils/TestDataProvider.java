...
public class TestDataProvider {
  ...
  public static Resume getTestResume(Long userId, Long experienceId, Long resumeId) {
    User user = new User(userId, "Ivan", "Petrov", "Ivan@gmail.com", LocalDateTime.now().minusYears(30), Role.USER, "some pass", "some activation code", ActiveStatus.ACTIVE, null, null, null, null,
        null, null);
