...
@Tag(name = "Контроллер проектов для админа", description = "Работа с проектами")
public class ProjectControllerForAdmin {
    ...
    @GetMapping
    public Page<ProjectResponseForAdmin> getAllProjects(@PageableDefault(size = 5) Pageable pageable) {
    ...
    public ProjectResponseForAdmin getProject(@PathVariable Long id) {
