...
@RequestMapping(value = UrlConstants.MAIN_URL_ADMIN + UrlConstants.EDUCATION_URL)
...
public class EducationControllerForAdmin {
    ...
    public EducationResponseForAdmin getById(@PathVariable Long id) {
    ...
    @PreAuthorize("hasAuthority('ADMIN')")
    @GetMapping
    public Page<EducationResponseForAdmin> getAllEducations(@PageableDefault(size = 5) Pageable pageable) {
