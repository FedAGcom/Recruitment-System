...
@RestController
@RequestMapping(value = UrlConstants.MAIN_URL_USER + UrlConstants.EXPERIENCE_URL)
@Tag(name = "Контроллер опыта работы для пользователя", description = "Работа с опытом работы")
public class ExperienceControllerForUser {
    ...
    public ExperienceResponseForUser getById(@PathVariable Long id) {
        return experienceService.findByIdForUser(id);
    }
